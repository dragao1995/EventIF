...
public class TelaLogin {
	...
	private void initialize() {
		...
		frameLogin.setIconImage(Toolkit.getDefaultToolkit().getImage(TelaCadastro.class.getResource("/br/edu/ifg/tads/mtp/eventif/view/if.png")));
		...
		lblIcon.setIcon(new ImageIcon(TelaLogin.class.getResource("/br/edu/ifg/tads/mtp/eventif/view/if.png")));
		lblIcon.setBounds(63, 97, 168, 169);
		frameLogin.getContentPane().add(lblIcon);

		
		btnLogin.setIcon(new ImageIcon(TelaLogin.class.getResource("/br/edu/ifg/tads/mtp/eventif/view/Symbol_-_Check.png")));
