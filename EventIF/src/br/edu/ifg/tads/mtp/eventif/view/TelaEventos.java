...
public class TelaEventos {
	...
	private void initialize() {
		...
		frmEventos.setIconImage(Toolkit.getDefaultToolkit().getImage(TelaEventos.class.getResource("/br/edu/ifg/tads/mtp/eventif/view/if.png")));
		...
		lblIcon.setIcon(new ImageIcon(TelaEventos.class.getResource("/br/edu/ifg/tads/mtp/eventif/view/if.png")));
